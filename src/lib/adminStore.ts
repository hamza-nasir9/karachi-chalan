...
export function recordEmail() { throw new Error("Use apiSendEmail — Resend is server-side only"); }
export function completeRequest() { throw new Error("Server marks COMPLETED on successful Resend"); }
