...
import {
  ShieldCheck, Lock, Eye, Mail, Clock3,
              ...
              <div className="grid lg:grid-cols-[1.02fr_0.98fr] gap-8 lg:gap-8 items-center">
                <div>
                  <div className="inline-flex items-center gap-2 rounded-full bg-white border border-[#0C1E3A]/[0.07] shadow-[0_4px_16px_rgba(12,30,58,0.06)] p-1 pr-2 text-[12.5px] font-medium max-w-full">
                    ...
                    <span className="hidden sm:inline text-[#2E4160] pr-1 truncate">Verified by our team • Email delivery</span>
                ...
                <div className="relative lg:pl-4 flex justify-center lg:justify-end">
                  ...
                  <div className="relative w-full max-w-[440px]">
                    ...
                    <motion.div initial={{ y: 8, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.35, duration: 0.5 }} className="hidden sm:flex absolute -left-4 top-[52%] items-center gap-3 bg-[#0C1E3A] text-white rounded-2xl px-4 py-3 shadow-[0_16px_40px_rgba(12,30,58,0.20)] border border-white/10">
                      ...
                      <div className="pr-1">
                        <div className="text-[12px] font-[800] leading-none">Verification</div>
          ...
          <section className="max-w-[1200px] mx-auto px-4 sm:px-6 pb-10 sm:pb-14">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
              {[
                ...
                { icon: UserCheck, title: "Human Verification", desc: "Every submission is checked by a person — not a bot. Responsible and accurate.", accent: "bg-[#0F2942]" },
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-14 sm:py-20">
              ...
              <div className="mt-10 sm:mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 relative">
                ...
                {SERVICE_LIST.map((svc, i) => {
                  ...
                  return (
                    <Link key={svc.type} to={`/services/${svc.slug}`} aria-label={`${svc.title} — open service form`} className="group relative block bg-[#FDFDFB] rounded-[22px] border border-[#0C1E3A]/[0.06] p-6 sm:p-7 text-center shadow-sm hover:shadow-[0_10px_24px_rgba(12,30,58,0.06)] hover:-translate-y-0.5 hover:border-[#0C1E3A]/15 transition-all focus-visible:rounded-[22px]">
                      <div className="w-16 h-16 mx-auto rounded-full bg-[#0C1E3A] text-white grid place-items-center shadow-[0_12px_28px_rgba(12,30,58,0.18)] relative">
                        <svc.icon size={22} />
                        <span className="absolute -top-1.5 -right-1.5 w-7 h-7 rounded-full bg-[#0F766E] text-white grid place-items-center text-[11px] font-[800] border-2 border-white shadow-sm">{n}</span>
                      </div>
                      <h3 className="mt-5 text-[16px] font-[800] tracking-[-0.01em]">{svc.title}</h3>
                      <p className="mt-2 text-[13.5px] leading-6 text-[#4A5A78]">{svc.cardDesc}</p>
                      <div className="mt-4 w-full h-px bg-[#0C1E3A]/5" />
                      <div className="mt-3 inline-flex items-center gap-1 text-[11px] font-[700] tracking-[0.1em] text-[#0F766E]">SERVICE {n} <ArrowRight size={12} className="transition-transform group-hover:translate-x-0.5" /></div>
                    </Link>
                  )
                })}
              </div>
                  ...
                  <div className="bg-white rounded-[22px] p-6 sm:p-7 text-[#0C1E3A] shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
                    ...
                    <div className="mt-5 grid gap-3">
                      {[
                        ...
                        { t: "Verification (24–48h)", d: "Team reviews your details" },
        ...
        <div className="min-h-[calc(100vh-108px)] bg-[#F8FAFC] border-b border-[#0C1E3A]/5">
          <div className="max-w-[840px] mx-auto px-4 sm:px-6 py-6 sm:py-10">
            ...
            <div className="mt-6 sm:mt-8">
              ...
              <p className="mt-2.5 text-[14px] sm:text-[15px] leading-6 text-[#4A5A78] max-w-[640px]">Fill step by step. Our team reviews and emails the result — no instant lookup.</p>
            </div>
