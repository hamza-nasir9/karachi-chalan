      ...
      <div className="flex-1 grid lg:grid-cols-[1.05fr_0.95fr] max-w-[1200px] w-full mx-auto">
        <div className="hidden lg:flex flex-col justify-center px-10 xl:px-14 py-12 bg-[#0C1E3A] text-white relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-[14px] leading-6 text-white/70 max-w-[440px] text-pretty">Review verification requests, check external sources, and email results to users. No automated scraping — human verification only.</p>
