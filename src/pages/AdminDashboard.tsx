      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[13.5px] leading-6 text-[#5B6B85] max-w-[600px] text-pretty">
            Overview of verification requests. Review new submissions, track progress and email results. <span className="font-[600] text-[#0C1E3A]">No automated lookup</span> — every request is verified by our team.
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-amber-50 border border-amber-200 px-4 py-3 flex gap-3 text-[13px] leading-5 text-amber-900">
          ...
          <div>
            ...
            <div className="mt-1 text-[12px] leading-5">
              ...
              Required: <span className="mono">MONGODB_URI</span>, <span className="mono">JWT_SECRET</span>, <span className="mono">SMTP_HOST</span>, <span className="mono">SMTP_PORT</span>, <span className="mono">SMTP_USER</span>, <span className="mono">SMTP_PASSWORD</span>, <span className="mono">SMTP_FROM</span>.
            </div>
          </div>
        </div>
      )}
          ...
          <table className="w-full min-w-[900px] text-[13px]">
            <thead className="bg-[#F8FAFC] text-[11px] font-[800] tracking-[0.08em] text-[#5B6B85]">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-[800]">SERVICE</th>
                  ...
                  <td className="px-4 py-4 whitespace-nowrap">
                    {r.vehicleRegistrationNumber ? (
                      <>
                        ...
                        {r.vehicleType && <span className="text-[#5B6B85] text-[12px] ml-2">{r.vehicleType}</span>}
                      </>
